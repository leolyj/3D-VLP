...
from lib.joint.solver_ft import Solver
...
def get_model(args, dataset, device):
    ...
    model = JointNet(
        ...
        dataset_config=DC,
        use_obj_embedding=True if args.use_multiview else False
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--tag", type=str, help="tag for the training, e.g. cuda_wl", default="FINETUNE")
    ...
    parser.add_argument("--use_multiview", action="store_true", help="Use multiview images.")  # 3D ONLY
    parser.add_argument("--use_topdown", type=bool, default=True, help="Use top-down attention for captioning.")
    ...
    parser.add_argument("--use_pretrained", type=str, default=None,
                        help="Specify the folder name containing the pretrained module.")
