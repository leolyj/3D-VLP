...
from lib.ap_helper.ap_helper_votenet import APCalculator, parse_predictions, parse_groundtruths
from lib.loss_helper.loss_qa import get_loss
from lib.joint.eval_qa import get_eval
from models.network.network_ft_qa import JointNet
from lib.configs.config_qa import CONF
        ...
        for trial, seed in enumerate(seeds):
            ...
            for data in tqdm(dataloader):
                ...
                for i in range(ids.shape[0]):
                    ...
                    pred_answers_at10 = [dataset.answer_vocab.itos(pred_answer_idx) for pred_answer_idx in
                                         pred_answer_idxs[i]]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--folder", type=str, default='', help="Folder containing the model")
    ...
    parser.add_argument("--no_nms", type=bool, default=True, help="do NOT use non-maximum suppression for post-processing.")
    parser.add_argument("--use_train", action="store_true", help="Use train split in evaluation.")
    parser.add_argument("--qa", type=bool, default=True, help="evaluate the qa results")
