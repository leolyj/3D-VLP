...
class RelationModule(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        for i in range(self.depth):
            ...
            # data_dict['relation'] = relation.detach().cpu()

            # dist_weights [10, 4, 256, 256]  mask [10, 256]
            dist_weights = dist_weights.permute(0, 2, 3, 1)  # [10, 256, 256, 4]
        ...
        data_dict["bbox_proj_emb"] = F.normalize(self.bbox_proj(features), dim=-1)
